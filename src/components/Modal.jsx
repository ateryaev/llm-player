...
const Modal = ({ isOpen, onClose, title, actionName, onAction, children }) => {
  ...
  return (
    <dialog ref={dialogRef} onClose={onClose}
      ...
      <div className="h-dvh bg-black/50 dark:bg-white/50 animate-[revealing_0.2s_ease-in-out]" tabIndex={0}>
        <div className="w-full dialogdiv flex flex-col bg-neutral-100 animate-[slideIn_0.2s_ease-in-out]">
          ...
          <div className="p-4 bg-white flex gap-4 justify-center z-30
